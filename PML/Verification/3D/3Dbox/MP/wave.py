...
# Parameters
A     = 2500  # Amplitude of the Ricker wavelet
dt    = 0.001   # Time step
t_max = 1.0     # Maximum time value
f0    = 1.5     # Central frequency of the Ricker wavelet
# f0    = 2.83 
# omegaL = 14.69
# omegaH = 36.74
# f0 = omegaL/(2*np.pi)
...
# shift the wavelet to the left
wavelet = np.roll(wavelet, -int(0.3/dt))
