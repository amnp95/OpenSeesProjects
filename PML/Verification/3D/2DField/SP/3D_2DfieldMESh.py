...
# change the Domain column to integer
elements['Domain'] = elements['Domain'].map({'pml': 1, 'reg': 0})

cells = elements[['tag', 'node1', 'node2', 'node3', 'node4', 'node5', 'node6', 'node7', 'node8', 'Domain']].to_numpy(dtype=int)
...
grid.cell_data["material"] = cells [:,-1]
pl = pv.Plotter()
