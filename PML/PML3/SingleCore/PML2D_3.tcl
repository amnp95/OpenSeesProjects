...
catch {eval "exec $pythonexec PML2D_3.py $lx $ly $dx $dy $pmlthicknessX  $pmlthicknessY $dxpml $dypml $regcores $pmlcores"} result 
# puts "result: $result"
...
if {$DOPML == "YES"} {
    ...
    set PMLmaterial "$E $nu $rho $pmlthicknessX $pmlthicknessY $RD_half_width_x $Depth 1.25 1e-8 200"
