...
data = np.loadtxt('Luco_vv_025_tipo_de_carga_11_duracion_1RichterLF.out',delimiter=',')
...
# plt.plot(data[:, 0], data[:, 3], label = "node 3")
plt.xlabel('Time (s)')
...
# data = np.loadtxt('NodeDisp0.out')
# axes[0].plot(data[:, 0], data[:, 1], label='PML2D_5')
# axes[1].plot(data[:, 0], data[:, 2], label='PML2D_5')
# axes[2].plot(data[:, 0], data[:, 3], label='PML2D_5')

# data = np.loadtxt('/home/amin/Projects/Github/OpenSeesProjects/PML/PML3/SingleCore/NodeDisp0.out')
