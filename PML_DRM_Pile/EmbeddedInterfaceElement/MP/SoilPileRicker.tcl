...
if {$pid == 0} {
    ...
    catch {eval "exec $pythonexec SoilPileRickerMesh.py $lx $ly $lz $dx $dy $dz $pmlthicknessx $pmlthicknessy $pmlthicknessz $numpmllayers $drmthicknessx $drmthicknessy $drmthicknessz $numdrmlayers $regcores $drmcores $pmlcores $meshdir $outputdir"} result 
    puts "result: $result"
...
if {$pid <$regcores} {
    ...
    set L2 5.0; # length of embedded pile (below ground surface) (m)
    set nElePile 16  ;# number of pile elements
